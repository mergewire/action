...
describe('sendPayload', () => {
  ...
  it('should send payload with correct headers', async () => {
    ...
    const result = await sendPayload('https://api.example.com', 'secret', mockPayload)
  ...
  it('should normalize API URL trailing slash', async () => {
    ...
    expect(mockFetch).toHaveBeenCalledWith('https://api.example.com/ingest', expect.any(Object))
  })
})
