...
import type { RoutingPayload, Repo, PullRequest, PayloadSource, Resource } from './core/types.js'
 ...
 */
export function buildRoutingPayload(options: BuildPayloadOptions): RoutingPayload {
